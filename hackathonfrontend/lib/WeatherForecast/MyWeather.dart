        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Heading12(widget.weatherData.areaName.toString(), Colors.white),
                        SizedBox(
                          width: 5,
                        ),
                ...
                Row(
                  children: [
                    weatherCondtion(widget.weatherData.weatherConditionCode!,),
                    SizedBox(
                      width: 10,
                    ),
                    Text(
                      widget.weatherData.temperature.toString().substring(0, widget.weatherData.temperature.toString().length-7),
                      style: TextStyle(
                        fontSize: 48,
                ...
                Row(
                  children: [
                    ...
                    Heading12(widget.weatherData.rainLast3Hours==null || widget.weatherData.rainLast3Hours!>0.5 ? "Chances of rain is low":"Chances of rain is high", Colors.grey),
                  ],
                ),
              ],
            ),
          ...
          Column(
            ...
            children: [
              ...
              Heading12("Chances of rain: ", Colors.grey),
              SizedBox(
                height: 5,
              ),
              Heading12("${widget.weatherData.rainLastHour==null? 12 : widget.weatherData.rainLastHour!*100}%", Colors.white),
              SizedBox(
                height: 20,
              ),
