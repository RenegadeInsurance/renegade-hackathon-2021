...
import 'package:weather/weather.dart' as wd;
...
class _WeatherState extends State<Weather> {
  ...
  late wd.WeatherFactory ws;
  List<wd.Weather> _data = [];
  ...
  void queryForecast() async {
    ...
    List<wd.Weather> forecasts = await ws.fiveDayForecastByLocation(lat!, lon!);
    setState(() {
      _data = forecasts;
  ...
  void queryWeather() async {
   ...
   wd. Weather weather = await ws.currentWeatherByLocation(lat!, lon!);
    setState(() {
      _data = [weather];
      _state = AppState.FINISHED_DOWNLOADING;
    });
      ...
      home: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            weatherCondtion(900, Colors.green),
